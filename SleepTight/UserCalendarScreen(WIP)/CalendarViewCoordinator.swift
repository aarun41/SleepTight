...
public class CalendarViewCoordinator<CellType: UICollectionViewCell & Configurable>: NSObject, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
